...
\hypersetup{
    ...
    filecolor=cyan,      
    urlcolor=magenta,
    pdftitle={Ebraheem Farag Curriculum Vitae},
...
Los Alamos National Laboratory: XTD Integrated Design \& Assessment (XTD-IDA)
\\ \textbf{(+1)~614~623~4875, \,  ebraheem.farag@yale.edu, \, ORCID: \href{https://orcid.org/0000-0002-5794-4286}{0000-0002-5794-4286}}
\\ \textbf{Website: \href{https://debraheem.github.io/}{debraheem.github.io}}
%\\ Astrophysics \hfill { School of Earth and Space Exploration}
\end{rSection}

\begin{rSection}{Research Interests}
Massive-star evolution, supernova progenitors, and pair-instability phenomena
\\Stellar neutrino emission and other multimessenger signatures of stellar evolution
\\Nuclear reaction rates, atomic opacities, and microphysics in stellar models
\\Classical pulsations, time-dependent 1D convection, and asteroseismic probes of stellar interiors
\\MESA development, validation, and software infrastructure for modern stellar evolution calculations
\end{rSection}
...
Modules for Experiments in Stellar Astrophysics (MESA) Software Developer \hfill{\em 2023 - present}
...
Lecturer: Modules for Experiments in Stellar Astrophysics (MESA) Summer School \hfill {\em 2026}
\\ \href{https://mesastar.org/summer-school-2026/}{Classical Cepheid Pulsations in MESA-star}
\\TA: Modules for Experiments in Stellar Astrophysics (MESA) Summer School \hfill {\em 2018-2025}
...
\input{generated_presentations.tex}
